...
BOT_NAME = 'shopee_webscraper'
SPIDER_MODULES = ['shopee_webscraper.spiders']
NEWSPIDER_MODULE = 'shopee_webscraper.spiders'
...
# FEED EXPORT
save_path = 'D:/shopee_etl_project/extract_exports'
    ...
    def start_requests(self):
        ...
        for items in code_list:
            url_list.append(
                ...
                + url_requests.get('address_appended_tail'))
