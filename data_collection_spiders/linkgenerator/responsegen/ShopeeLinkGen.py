...
import pandas as pd
from linkgen import ShopeeScrape
...
class EventsFunc:
    ...
    def export():
        ...
        return export_data.to_csv(f'../../../generated_links/{TODAY}_links(BASE).csv')
...
# Window Layout
layout = [
    [sg.Text('filepath', size=(10, 1), auto_size_text=False, justification='left'),
...
window = sg.Window('Shopee - Link Generator',
          layout,
          size=(500, 90),
          icon=r'E:\cj-files\Shopee ETL\Global Input\Generator\shopee_linkgen.ico')
